...
{
    public partial class updatecrf11b : System.Web.UI.Page
    {
        ...
        protected void next_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    SqlCommand cmd = new SqlCommand("update crf11 set lw_crf11_15='" + txtq15.Text + "', lw_crf11_15x='" + txtq15x.Text + "', lw_crf11_16='" + txtq16.Text + "', lw_crf11_17='" + txtq17.Text + "', lw_crf11_18='" + txtq18.Text + "', lw_crf11_19='" + txtq19.Text + "', lw_crf11_20='" + txtq20.Text + "',lw_crf11_21='" + txtq21.Text + "',lw_crf11_22='" + txtq22.Text + "', lw_crf11_23='" + txtq23.Text + "', lw_crf11_24='" + txtq24.Text + "', lw_crf11_25='" + txtq25.Text + "', lw_crf11_26='" + txtq26.Text + "', lw_crf11_27='" + txtq27.Text + "', lw_crf11_28='" + txtq28.Text + "', lw_crf11_29='" + txtq29.Text + "', lw_crf11_30='" + txtq30.Text + "', lw_crf11_31='" + txtq31.Text + "', update_dt='" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + "', update_nm='" + Convert.ToString(Session["ComplianceMaamtaLW"]) + "'  where id='" + Request.QueryString["FormID"] + "'  and status='1'", cn);
                    cmd.ExecuteNonQuery();
                    Response.Redirect("updatecrf11c.aspx?&FormID=" + Request.QueryString["FormID"] );
                }
            }
            catch (Exception ex)
            {
        ...
        {
            SqlConnection con = new SqlConnection(ConDataBase);
            SqlCommand cmd = new SqlCommand("select count(*) as total from crf11_q32 where crf11_id='" + Request.QueryString["FormID"] + "'", con);
            con.Open();
            try
            {
        ...
        {
            SqlConnection con = new SqlConnection(ConDataBase);
            SqlCommand cmd = new SqlCommand("select * from crf11_q32 where crf11_id='" + Request.QueryString["FormID"] + "' order by id");
            con.Open();
            {
                try
                {
        ...
        protected void Link_Button1(object sender, EventArgs e)
        {
            ...
            SqlConnection con = new SqlConnection(ConDataBase);
            SqlCommand cmd = new SqlCommand("select * from crf11_q32 where crf11_id='" + Request.QueryString["FormID"] + "' and rec_id='" + forUpdateRec + "'", con);
            con.Open();
            try
            {
                SqlDataReader dr = cmd.ExecuteReader();
