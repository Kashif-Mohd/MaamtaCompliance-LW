...
{
    public partial class updatecrf11d : System.Web.UI.Page
    {
        ...
        protected void submit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmd.ExecuteNonQuery();
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alerts", "javascript:alert('Form Update Successfully!');window.location.href='dashPhysician.aspx';", true);
                }
            }
            catch (Exception ex)
            {
