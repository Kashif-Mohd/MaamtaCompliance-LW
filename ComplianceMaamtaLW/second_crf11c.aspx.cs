...
{
    public partial class second_crf11c : System.Web.UI.Page
    {
        ...
        protected void next_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                SqlCommand cmd = new SqlCommand("update second_crf11 set lw_crf11_33='" + txtq33.Text + "', lw_crf11_34='" + txtq34.Text + "', lw_crf11_35='" + txtq35.Text + "', lw_crf11_36a='" + txtq36a.Text + "', lw_crf11_36b='" + txtq36b.Text + "', lw_crf11_37='" + txtq37.Text + "', lw_crf11_38a='" + txtq38a.Text + "',lw_crf11_38b='" + txtq38b.Text + "',lw_crf11_39='" + txtq39.Text + "', lw_crf11_40='" + txtq40.Text + "', lw_crf11_41a='" + txtq41a.Text + "', lw_crf11_41b='" + txtq41b.Text + "', lw_crf11_42='" + txtq42.Text + "', lw_crf11_43='" + txtq43.Text + "', lw_crf11_44='" + txtq44.Text + "', lw_crf11_45='" + txtq45.Text + "', lw_crf11_46='" + txtq46.Text + "', lw_crf11_47='" + txtq47.Text + "', lw_crf11_48='" + txtq48.Text + "', lw_crf11_49='" + txtq49.Text + "', lw_crf11_50='" + txtq50.Text + "', lw_crf11_51='" + txtq51.Text + "', lw_crf11_52='" + txtq52.Text + "', lw_crf11_53='" + txtq53.Text + "', lw_crf11_54='" + txtq54.Text + "', lw_crf11_55='" + txtq55.Text + "', lw_crf11_56='" + txtq56.Text + "', lw_crf11_57='" + txtq57.Text + "', lw_crf11_58='" + txtq58.Text + "', lw_crf11_59_01='" + txtq59a.Text + "', lw_crf11_59_02='" + txtq59b.Text + "', lw_crf11_59_03='" + txtq59c.Text + "', lw_crf11_59_04='" + txtq59d.Text + "', lw_crf11_60='" + txtq60.Text + "', lw_crf11_61='" + txtq61.Text + "', lw_crf11_62='" + txtq62.Text + "', lw_crf11_63='" + txtq63.Text + "', entry_dt='" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + "', entry_nm='" + Convert.ToString(Session["ComplianceMaamtaLW"]) + "'  where id='" + Request.QueryString["FormID"] + "' and status='0'", cn);
                cmd.ExecuteNonQuery();
                Response.Redirect("second_crf11d.aspx?&FormID=" + Request.QueryString["FormID"] + "&RandID=" + Request.QueryString["RandID"]);
            }
            catch (Exception ex)
            {
