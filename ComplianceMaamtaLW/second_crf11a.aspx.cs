...
{
    public partial class second_crf11a : System.Web.UI.Page
    {
        //MySQL 
        ...
        protected void next_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else if (StatusCheck2ndEntry() == true)
                {
        ...
        public void CheckFormID()
        {
            ...
            SqlCommand cmd = new SqlCommand("select id from second_crf11 where assist_id='" + txtAssisid.Text + "' and lw_crf11_03dt='" + txtDOV.Text + "'", con);
            con.Open();
            try
            {
        ...
        public bool StatusCheck2ndEntry()
        {
            bool exist = false;
            SqlConnection con = new SqlConnection(ConDataBase);
            SqlCommand cmd = new SqlCommand("select * from second_crf11 where assist_id='" + txtAssisid.Text + "' and lw_crf11_03dt='" + txtDOV.Text + "' and status='1'", con);
            con.Open();
            try
            {
                SqlDataReader dr = cmd.ExecuteReader();
        ...
        public bool StatusCheck1stEntry()
        {
            bool exist = false;
            SqlConnection con = new SqlConnection(ConDataBase);
        ...
        public bool CheckIncomplete()
        {
            bool exist = false;
            SqlConnection con = new SqlConnection(ConDataBase);
            SqlCommand cmd = new SqlCommand("select * from second_crf11 where assist_id='" + txtAssisid.Text + "' and lw_crf11_03dt='" + txtDOV.Text + "' and status='0'", con);
            con.Open();
            try
            {
                SqlDataReader dr = cmd.ExecuteReader();
