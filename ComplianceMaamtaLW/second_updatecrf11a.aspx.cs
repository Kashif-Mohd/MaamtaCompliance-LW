...
{
    public partial class second_updatecrf11a : System.Web.UI.Page
    {
        ...
        public void FieldFill()
        {
            ...
            try
            {
                ...
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alerts", "javascript:alert('Form status is Incomplete');window.location.href='dashSecondPhysician.aspx';", true);
                }
            }
            finally
            {
