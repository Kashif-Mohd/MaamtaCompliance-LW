<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="crf8d.aspx.cs" Inherits="ComplianceMaamtaLW.crf8d" Culture="ar-DZ" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function clicknext() {
            var Q49_01 = document.getElementById('<%= chkQ49_01.ClientID %>');
            var Q49_02 = document.getElementById('<%= chkQ49_02.ClientID %>');
            var Q49_03 = document.getElementById('<%= chkQ49_03.ClientID %>');
