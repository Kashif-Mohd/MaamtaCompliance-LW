<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ReportCRF8.aspx.cs" Inherits="ComplianceMaamtaLW.ReportCRF8" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
     ...
     <div style="padding-left: 2%; margin-top: 15px;">
        ...
        <div style="color: #ff6b6b; font-size: 22px; width: 100%">
            ADVERSE EVENTS REPOPRTING FORM (CRF-8):
                ...
                <ContentTemplate>
                    ...
                    <div class="Mobile" id="calendar" runat="server">
                        <table style="width: 100%; text-align: center; margin-left: 1%; margin-bottom: 15px">
                            <tr>
                                <td class="tddd">
                                    <asp:TextBox ID="txtCalndrDate" Font-Bold="true" Font-Size="16px" ClientIDMode="Static" CssClass="txtboxxx" Height="32px" runat="server" Width="8.0em"></asp:TextBox>
                                    ...
                                    &nbsp To &nbsp
                                <asp:TextBox ID="txtCalndrDate1" Font-Bold="true" Font-Size="16px" CssClass="txtboxxx" Height="32px" runat="server" Width="8.0em"></asp:TextBox>
            ...
            <div style="width: 100%; overflow: auto">
                <asp:GridView ID="GridView1" runat="server" EmptyDataText="No Record Found." CssClass="footable" AllowPaging="True" PageSize="200" OnPageIndexChanging="GridView1_PageIndexChanging" AllowSorting="false" ForeColor="#333333" AutoGenerateColumns="false">
                    <Columns>
                        ...
                        <asp:BoundField DataField="q2" HeaderText="Date (Q2)" />
                        <asp:BoundField DataField="q16" HeaderText="ADR Observed (Q16)" />
                        <asp:TemplateField HeaderText="">
                            <ItemTemplate>
                                <asp:LinkButton ID="Link_Study_id" OnClick="Link_Study_id" Text='View Report' runat="server" ToolTip="Open Reporting Form" CommandArgument='<%#Eval("study_id")+","+ Eval("id")%>'></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
    ...
    <div style="width: 100%; padding-left: 2%; overflow: scroll; height: auto" runat="server" id="DivReport" visible="false">
        ...
        <rsweb:ReportViewer ID="ReportViewer" runat="server" Width="100%" Style="height: 100%" SizeToReportContent="true"></rsweb:ReportViewer>
    </div>
