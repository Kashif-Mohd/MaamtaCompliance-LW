...
{
    public partial class second_crf11d : System.Web.UI.Page
    {
        ...
        protected void submit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmd.ExecuteNonQuery();
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alerts", "javascript:alert('Form Saved Successfully!');window.location.href='second_crf11a.aspx';", true);
        ...
        public void deleteQ70Records()
        {
            ...
            try
            {
                if (txtq69.Text != "1")
                {
                    SqlCommand cmd = new SqlCommand("delete from second_crf11_q70 where crf11_id='" + Request.QueryString["FormID"] + "'", con);
                    cmd.ExecuteNonQuery();
                }
            }
            finally
