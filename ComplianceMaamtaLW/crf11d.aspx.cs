...
{
    public partial class crf11d : System.Web.UI.Page
    {
        ...
        {
            SqlConnection con = new SqlConnection(ConDataBase);
            SqlCommand cmd = new SqlCommand("select count(*) as total from crf11_q70 where crf11_id='" + Request.QueryString["FormID"] + "'", con);
            con.Open();
            try
            {
        ...
        {
            SqlConnection con = new SqlConnection(ConDataBase);
            SqlCommand cmd = new SqlCommand("select * from crf11_q70 where crf11_id='" + Request.QueryString["FormID"] + "' order by id");
            con.Open();
            {
                try
                {
        ...
        protected void Link_Button1(object sender, EventArgs e)
        {
            ...
            SqlConnection con = new SqlConnection(ConDataBase);
            SqlCommand cmd = new SqlCommand("select * from crf11_q70 where crf11_id='" + Request.QueryString["FormID"] + "' and rec_id='" + forUpdateRec + "'", con);
            con.Open();
            try
            {
                SqlDataReader dr = cmd.ExecuteReader();
