...
{
    public partial class crf11b : System.Web.UI.Page
    {
        ...
        protected void next_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmd.ExecuteNonQuery();
                    Response.Redirect("crf11c.aspx?&FormID=" + Request.QueryString["FormID"] + "&RandID=" + Request.QueryString["RandID"]);
                }
            }
            catch (Exception ex)
            {
        ...
        {
            SqlConnection con = new SqlConnection(ConDataBase);
            SqlCommand cmd = new SqlCommand("select * from crf11 where id='" + Request.QueryString["FormID"] + "'  and status='0'", con);
            con.Open();
            try
            {
                SqlDataReader dr = cmd.ExecuteReader();
